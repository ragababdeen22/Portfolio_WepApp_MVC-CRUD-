...
namespace Web.Controllers
{
    public class PortfolioItemsController : Controller
    {
        ...
        public PortfolioItemsController(/*DataContext context,*/ IUnitOfWork<Portfolio> portfolio, IHostingEnvironment hosting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(Guid id, [Bind("ProjectName,Description,ImgUrl,Id")] Portfolio portfolio)
